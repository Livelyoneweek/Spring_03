...
class FoodIntegrationTest {
    ...
    class RegisterRestaurants {
        ...
        void test1() throws JsonProcessingException {
            ...
            ResponseEntity<Object> response = restTemplate.postForEntity("/restaurant/"+restaurantId+"/food/register", request, Object.class);
    ...
    class FoodName {
        ...
        @Test
        @Order(4)
        @DisplayName("음식점2에 음식명 1에 등록되어 있는 음식명 입력 가능")
